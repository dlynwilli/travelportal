...
class AdminProcess
{
   ...
   function AdminProcess(){
	  ...
	  /* Admin submitted assign do */
      else if(isset($_POST['subdouser'])){
         $this->procDOUser();
      }
	  /* Admin submitted assign do */
      else if(isset($_POST['substatuser'])){
         $this->procChgStatUser();
      }
   ...
   function procDeleteUser(){
    ...
    /**
    * procDOUser - Assign DO to reviewer
    */
   function procDOUser(){
      global $session, $database, $form;
      /* Username error checking */
      $subuser = $this->checkUsername("douser");
      ...
      /* Update user level */
	  	 ...
	  	 $mydo = $_POST['do'];
	     $q = "UPDATE ".TBL_USERS." SET do='".$mydo."' WHERE username='$subuser'";
         $database->query($q);
         header("Location: ".$session->referrer);
		 }
   }
    ...
    /**
    * procStatUser - Assign DO to reviewer
    */
   function procChgStatUser(){
      global $session, $database, $form;
      /* Username error checking */
      $subuser = $this->checkUsername("statuser");
      ...
      /* Update user level */
	     ...
	     $q = "UPDATE ".TBL_USERS." SET sendemail='".$mystatus."' WHERE username='$subuser'";
         $database->query($q);
         header("Location: ".$session->referrer);
		 }
   }
