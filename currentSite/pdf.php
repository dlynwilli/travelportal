...
if ($do == "S3 DO53") {
	...
	$pdf->SetFont('Arial','B',10);
	$pdf->SetXY(55,15);
	$pdf->Cell(130,4,'U.S. ARMY',0,1,'C');
	$pdf->SetFont('Arial','',8);
	$pdf->SetXY(55,19);
	$pdf->Cell(130,3,'COMMUNICATIONS-ELECTRONICS COMMAND (CECOM)',0,1,'C');
	$pdf->SetXY(55,22);
	$pdf->Cell(130,3,'SYSTEMS ENGINEERING CENTER (SEC)',0,1,'C');
	$pdf->SetXY(55,25);
	$pdf->Cell(130,3,'6002 COMBAT DRIVE',0,1,'C');
	$pdf->SetXY(55,28);
	$pdf->Cell(130,3,'ABERDEEN PROVING GROUNDS, MARYLAND 21005-5001',0,1,'C');
	...
	$pdf->SetFont('Times','',12);
	$pdf->SetXY(27,42);
	$pdf->Cell(40,5,'AMSEL-SE-WS',0,1,'L');
...
if ($do == "S3 DO56") {
	...
	$html1='<br>1. <u>'. $fullname . '</u>, the bearer of this letter, is an employee of Booz Allen Hamilton (BAH) Inc. or a BAH subsidiary company (or a BAH subcontractor), which is under this agency\'s Government contract W15P7T-06-D-E401. During the period of <u>' . $depdate . ' through ' . $retdate .'</u>, this employee is eligible and authorized to use available discount rates in accordance with your contract or agreement with the Federal Government.<br><br>';
	$html2='2. The Government Project Lead for this project is Mr. Larry Lashine, AMSRD-CER-SE-IEW-DCGS, available at 443-861-4976 or larry.lashine.civ@mail.mil. The Contracting Officer\'s Representative (COR) for this contract is Mr. Huy Pham, available at 443-861-3768 or huy.x.pham.civ@mail.mil.';
	...
	$pdf->SetFont('Times','',12);
	$pdf->SetXY(10,63);
	$pdf->Cell(170,5,'From: Commander, US Army Communications Electronics Command (CECOM)',0,1,'L');
	$pdf->SetXY(10,68);
	$pdf->Cell(170,5,'To:     Service Vendors',0,1,'L');
	$pdf->SetXY(10,78);
	$pdf->Cell(170,5,'Subject: OFFICIAL TRAVEL OF GOVERNMENT CONTRACTORS',0,1,'L');
...
if ($do == "TESS DO23") {
	...
	$html1='<br>1. <u>'. $fullname . '</u>, the bearer of this letter, is an employee of Booz Allen Hamilton (BAH) Inc. or a BAH subsidiary company (or a BAH subcontractor), which is under this agency\'s Government contract W15P7T-09--D-P014/23. During the period of <u>' . $depdate . ' through ' . $retdate .'</u>, this employee is eligible and authorized to use available discount rates in accordance with your contract or agreement with the Federal Government.<br><br>';
	$html2='2. The Contracting Officer\'s Representative (COR) for this contract is Mr. Kevin Williams, available at 443-861-1483 or kevin.d.williams3.civ@mail.mil. The Government Project Lead for this project is Mr. Clinton Brown, available at 443-861-0688 or Clinton.b.brown@us.army.mil.';
...
if ($do == "R23G DO06") {
	...
	$html1='<br>1. <u>'. $fullname . '</u>, the bearer of this letter, is an employee of Booz Allen Hamilton (BAH) Inc. or a BAH subsidiary company (or a BAH subcontractor), which is under this agency\'s Government contract W15P7T10-D-D415. During the period of <u>' . $depdate . ' through ' . $retdate .'</u>, this employee is eligible and authorized to use available discount rates in accordance with your contract or agreement with the Federal Government.<br><br>';
	$html2='2. The Contracting Officer\'s Representative (COR) for this contract is Mr. Thien Huynh, available at 443-861-0686 or thien.k.huynh.civ@mail.mil. The Government Project Lead for this project is Mrs. Courtney Coulter, available at 443-861-0708 or courtney.h.coulter.civ@mail.mil.';
	...
	$pdf->SetFont('Arial','',8);
	$pdf->SetXY(55,19);
	$pdf->Cell(130,3,'COMMUNICATIONS-ELECTRONICS COMMAND',0,1,'C');
	$pdf->SetXY(55,22);
	$pdf->Cell(130,3,'LIFE CYCLE MANAGEMENT COMMAND',0,1,'C');
	$pdf->SetXY(55,25);
	$pdf->Cell(130,3,'ABERDEEN PROVING GROUNDS, MARYLAND 21005-5001',0,1,'C');
	...
	$pdf->SetFont('Times','',12);
	$pdf->SetXY(10,63);
	$pdf->Cell(170,5,'From: Commander, US Army Communications-Electronics Command',0,1,'L');
	$pdf->SetXY(21.5,68);
	$pdf->Cell(170,5,'Life Cycle Management Command(CECOM LCMC)',0,1,'L');
	$pdf->SetXY(10,72);
	$pdf->Cell(170,5,'To:     Service Vendors',0,1,'L');
	$pdf->SetXY(10,82);
	$pdf->Cell(170,5,'Subject: OFFICIAL TRAVEL OF GOVERNMENT CONTRACTORS',0,1,'L');
...
if ($do == "R23G DO07") {
	...
	$html1='<br>1. <u>'. $fullname . '</u>, the bearer of this letter, is an employee of Booz Allen Hamilton (BAH) Inc. or a BAH subsidiary company (or a BAH subcontractor), which is under this agency\'s Government contract W15P7T-10-D-D415/07. During the period of <u>' . $depdate . ' through ' . $retdate .'</u>, this employee is eligible and authorized to use available discount rates in accordance with your contract or agreement with the Federal Government.<br><br>';
	$html2='2. The Contracting Officer\'s Representative (COR) for this contract is Ms. Jacqueline May, available at jacqueline.c.may@us.army.mil. The Government Project Lead for this project is Mr. Kesny Parent, available at kesny.parent.civ@mail.mil.';
