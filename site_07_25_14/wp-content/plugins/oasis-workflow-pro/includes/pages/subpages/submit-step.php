...
<div class="info-setting" id="new-step-submit-div" style="display:none;">
	...
	<div>
		...
		<div id="update_publish_msg" class="message hidden">
		   <?php echo __("Signing off will copy over the contents of this revised article to the corresponding published article.")?>
		</div>
