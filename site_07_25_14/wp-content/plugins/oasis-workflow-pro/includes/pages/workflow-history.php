	...
	<div id="view-workflow" class="workflow-history">
		<div class="tablenav">
			<div class="alignleft actions">
				...
				<input type="button" class="button-secondary action" id="download" value="<?php echo __("Download Workflow History Report", "oasisworkflow"); ?>" />
...
jQuery(document).ready(function()
{
	...
	{
		data = {
			action: 'download_history_report',
			post: jQuery('#post_filter').val()
		};

		jQuery.post(ajaxurl, data, function( response ) {
			window.location="<?php echo OASISWF_URL; ?>includes/workflow-report-download.php?file="+response;
		});
	});
});
</script>